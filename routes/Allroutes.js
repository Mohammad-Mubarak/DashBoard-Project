...
const {Register,loginuser,addProduct,getAllProduct,deleteProduct,updateProduct,findOneProduct,searchOne} = require("../controllers/Controllers")
...
// searching route
router.route("/search/:id").get(searchOne)
